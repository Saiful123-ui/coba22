...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [101.340439, -1.972632, 101.367572, -1.958122], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [101.128420, -2.351904, 126871.534150, 9812758.108162],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([101.340439, -1.972632, 101.367572, -1.958122], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_BANGUNAN_PELANGGAN_2,
    colName: 'ID_2',
    zoom: 10,
    collapsed: true,
    map: map
